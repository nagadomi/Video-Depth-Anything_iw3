...
if __name__ == '__main__':
    ...
    video_depth_anything = VideoDepthAnythingStreamingTorch(device=DEVICE, **model_configs[args.encoder])
    ...
    while cap.isOpened():
        ...
        if frame_count % stride == 0:
            ...
            # Inference depth
            depth = video_depth_anything.infer_video_depth_one(frame, use_amp=not args.fp32)
            depth = F.interpolate(depth.unsqueeze(0), size=(src_height, src_width),
